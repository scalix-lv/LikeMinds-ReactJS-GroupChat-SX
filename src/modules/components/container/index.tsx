...
const Container: React.FC = () => {
  ...
  return (
    <>
      <div className={`flex-[.32] bg-white border-r-[1px] border-[#eeeeee] overflow-auto feed-panel relative `}>
        <FeedWrapper />
      </div>
      <div
        className={`flex-[.68] bg-[#FFFBF2] relative pt-[20px] flex flex-col ${
          routeContext.isNavigationBoxOpen ? 'sm:max-md:absolute sm:max-md:z-[-1] z:max-sm:hidden' : 'z:max-md:flex-[1]'
        }`}
      >
